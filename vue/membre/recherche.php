  		...
  		<div class="content-bottom">
			...
			<div class="clear"></div>
			   ...
			   <div class="chercher">
			   	...
			   	<form action="<?php echo Router::url('Membre/recherche')?>" method="post">
					<?php 
				...
				?>
			   	...
			   	<?php foreach ($produit as $key => $value): ?>
					<div class="col_1_of_2 span_1_of_2">
						<!-- a href="<?php echo Router::url("Membre/reservation_details/id:{$produits[1]->id_produit}"); ?>"-->
						<a href="<?php echo Router::url('Membre/reservation_details/'.$value->id_produit); ?>">
