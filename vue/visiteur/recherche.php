...
<div class="main">
    <div class="wrap">
  		<div class="content-bottom">
			<div class="wrap">
				 <div class="chercher">
				 	<form action="<?php echo Router::url('Visiteur/recherche')?>" method="post">
					<?php 
					...
					?>
						...
						<div class="col_1_of_middle span_1_of_middle row">
							...
							<div class="motcle"><?php echo $this->Form->input('mot_clef','Mots clé');?></div>
		   				 </div>
				...
				?>
			   	...
			   	<?php foreach ($produit as $key => $value): ?>
					<div class="col_1_of_2 span_1_of_2">
						<!-- a href="<?php echo Router::url("Visiteur/reservation_details/id:{$produits[1]->id_produit}"); ?>"-->
