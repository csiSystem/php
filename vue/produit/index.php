						...
						?>	  
					   	...
					   	<div class="banner-wrap">
							 ...
							 <div class="slider-right">
							    ...
							    <a href="<?php echo Router::url("produit/reservation_details/id:{$produits[1]->id_produit}"); ?>"> &rarr;Fiche detaillée</a>

							    <div class="btn">
							    	<a href="<?php echo Router::url('connection/connexion_panier/'.$produits[1]->id_produit);?>">Réserver</a>
							    </div>
							 </div>
							 <div class="clear"></div>
						</div>
    ...
    <div class="wrap">
			...
			<div class="box1">
			   	...
			   	<?php foreach ($last_produit as $key => $value): ?>
					<div class="col_1_of_3 span_1_of_3">
						<a href="<?php echo Router::url("produit/reservation_details/id:{$produits[1]->id_produit}"); ?>">
							...
							<ul class="list">
							    <li>
								  	...
								  	<ul class="icon1 sub-icon1 profile_img">
									  	<li>
										  	<a class="active-icon c1" href="<?php echo Router::url('connection/connexion_panier/'.$produits[1]->id_produit);?>">Ajouter au panier</a>
		...
		<div class="content-top">
			...
			<div class="cont span_2_of_c1">
			  	<div class="social">	
			     	<ul>	
				  		<li class="facebook"><a href="#"><span> </span></a><div class="radius"> <img src="web/images/radius.png"><a href="#"> </a></div><div class="border hide"><p class="num">1.51K</p></div></li>
				 	</ul>
	   		   </div>
			   <div class="social">	
				   	<ul>	
						<li class="twitter"><a href="#"><span> </span></a><div class="radius"> <img src="web/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
				  	</ul>
	     		</div>
				 	<div class="social">	
					   	<ul>	
							<li class="google"><a href="#"><span> </span></a><div class="radius"> <img src="web/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
					   	</ul>
		    		</div>
				<div class="social">	
					<ul>	
						<li class="dot"><a href="#"><span> </span></a><div class="radius"> <img src="web/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
					</ul>
	     		</div>
				<div class="clear"> </div>
			</div>
